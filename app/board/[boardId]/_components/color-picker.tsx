...
export const ColorPicker = ({
  ...
  return (
    <div className="flex flex-col gap-4 items-center max-w-[164]px pr-2 mr-2 border-r border-neutral-200" >
      <div className="flex flex-wrap gap-2 items-center max-w-[82]px" >
